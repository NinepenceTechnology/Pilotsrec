...
export const OperationsView: React.FC<OperationsViewProps> = ({
  ...
  const { maneuvers, exportManeuversToCsv, deleteManeuver, canEditManeuver } = useMaritime();
    ...
    <div className="space-y-5 text-slate-900">
      ...
      <div className="bg-white border-2 border-black rounded-xl p-4 sm:p-5 shadow flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-black text-black tracking-tight mt-0.5 flex items-center gap-2">
            <Anchor className="w-5 h-5 sm:w-6 sm:h-6 text-blue-900" />
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="px-2.5 py-1.5 rounded-lg border border-slate-400 bg-white hover:bg-slate-100 font-bold text-xs text-black flex items-center gap-1.5 transition-colors shadow-xs"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-blue-900 hover:bg-blue-800 text-white font-black text-xs tracking-wide border border-black shadow-xs flex items-center gap-1.5 transition-all active:scale-95 cursor-pointer"
          >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 pb-3">
                  ...
                  <div className="flex items-center gap-1.5 self-end sm:self-auto">
                    ...
                    <button
                      ...
                      title="Descarregar PDF Oficial de Manobra"
                      className="px-2 py-1 rounded bg-black hover:bg-slate-800 text-white font-bold text-xs flex items-center gap-1 transition-colors border border-black"
                    >
                      <Download className="w-3 h-3 text-blue-300" />
                      <span className="hidden sm:inline">PDF</span>
                    </button>

                    {/* Somente o usuário ou dispositivo que registou pode editar seus dados */}
                    {canEditManeuver(m) ? (
                      <>
                        {onEditManeuver && (
                          <button
                            ...
                            className="p-1 rounded bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300"
                    ...
                    <button
                      ...
                      className="p-1 rounded bg-slate-100 hover:bg-slate-200 text-black border border-slate-300"
