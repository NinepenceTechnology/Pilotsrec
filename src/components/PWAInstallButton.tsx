...
import { Download, Smartphone, X, Check, Share2, PlusSquare, Monitor, Laptop } from 'lucide-react';
  ...
  return (
    <>
      <button
        ...
        title="Instalar Pilot's Records como aplicativo PWA no dispositivo"
      >
          ...
          <div className="w-full max-w-sm rounded-xl bg-white p-5 shadow-2xl border-2 border-black text-slate-900 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-700">
              ...
              <div className="flex items-start gap-3 bg-slate-50 p-2.5 rounded-lg border border-slate-200">
                ...
                <div>
                  Toque em <strong>Adicionar</strong> no canto superior direito. O aplicativo funcionará offline com acesso direto!
                </div>
              </div>
            </div>
      ...
      {/* Desktop / Android Fallback Instruction Modal */}
      {showDesktopGuide && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="w-full max-w-md rounded-xl bg-white p-5 shadow-2xl border-2 border-black text-slate-900 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 pb-2">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-blue-900 text-white flex items-center justify-center font-bold">
            ...
            <div className="space-y-3 text-xs text-slate-700">
              <div className="flex items-start gap-3 bg-slate-50 p-3 rounded-lg border border-slate-200">
                ...
                <div>
                  <strong>No Chrome ou Edge (Computador):</strong><br />
                  Clique no ícone de instalação <Download className="w-3.5 h-3.5 inline mx-0.5 text-blue-700" /> situado no canto direito da barra de endereço, ou abra o menu <strong>⋮ (três pontos) &gt; "Instalar Pilot's Records"</strong>.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 bg-slate-50 p-3 rounded-lg border border-slate-200">
                ...
                <div>
                  <strong>No Android (Chrome / Samsung Internet):</strong><br />
                  Toque no menu <strong>⋮ (três pontos)</strong> no topo do navegador e selecione <strong>"Instalar aplicativo"</strong> ou <strong>"Adicionar ao ecrã inicial"</strong>.
                </div>
              </div>

              <div className="p-2.5 bg-blue-50 border border-blue-200 rounded-lg text-blue-950 text-[11px]">
                💡 <em>Uma vez instalada, a aplicação funciona em ecrã total sem barra de navegação, com suporte offline completo e sincronização automática.</em>
              </div>
            </div>
